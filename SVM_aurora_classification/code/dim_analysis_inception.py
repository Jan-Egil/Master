...
path_feats = base_dir + '/data/SVM_aurora_classification/inception/auroral_feat.h5'
path_classification = base_dir + '/data/SVM_aurora_classification/classifications.csv'
