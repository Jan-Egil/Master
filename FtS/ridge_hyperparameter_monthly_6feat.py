...
for alphaiter, alpha in enumerate(tqdm(alphas)):
    ...
    recalls_per_alpha[alphaiter] = np.mean(recall_list)
    balanced_acc_per_alpha[alphaiter] = np.mean(balanced_acc_list)
    fitting_time_per_alpha[alphaiter] = np.mean(fitting_time_list)
    classification_time_per_alpha[alphaiter] = np.mean(predicting_time_list)
    total_time_per_alpha[alphaiter] = np.mean(total_time_list)

os.chdir('data')
np.save('alphas', alphas)
np.save('recalls_per_alpha', recalls_per_alpha)
np.save('balanced_acc_per_alpha', balanced_acc_per_alpha)
np.save('fitting_time_per_alpha', fitting_time_per_alpha)
np.save('predicting_time_per_alpha', classification_time_per_alpha)
np.save('total_time_per_alpha', total_time_per_alpha)